  ...
  const platforms: Platform[] = [
    {
      name: 'Spotify',
      logo: spotifyLogo,
      color: 'bg-white/5 hover:bg-white/10 shadow-[8px_8px_16px_rgba(0,0,0,0.4),-8px_-8px_16px_rgba(255,255,255,0.05)] hover:shadow-[inset_4px_4px_8px_rgba(0,0,0,0.4),inset_-4px_-4px_8px_rgba(255,255,255,0.05)]',
      ...
      <div className="flex flex-col items-center gap-3 w-full max-w-md mx-auto animate-fade-in">
        {platforms.map((platform) => (
          <Button
            ...
            className={`${platform.color} text-white font-semibold py-6 text-lg transition-all w-full rounded-xl`}
            size="lg"
          >
